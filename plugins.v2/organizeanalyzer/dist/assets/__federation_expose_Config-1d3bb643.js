  ...
  return (_openBlock(), _createBlock(_component_v_card, { flat: "" }, {
    default: _withCtx(() => [
      _createVNode(_component_v_card_text, null, {
        default: _withCtx(() => [
          _cache[18] || (_cache[18] = _createElementVNode("div", { class: "text-subtitle-1 mb-4 font-weight-bold" }, " 全局设置 ", -1)),
          ...
          _cache[19] || (_cache[19] = _createElementVNode("div", { class: "text-subtitle-1 mb-4 font-weight-bold" }, " 异常检测规则开关及参数 ", -1)),
          _createVNode(_component_v_row, { dense: "" }, {
            default: _withCtx(() => [
              _createVNode(_component_v_col, {
                cols: "12",
                ...
                default: _withCtx(() => [
                  _createVNode(_component_v_switch, {
                    modelValue: config.value.detect_title_mismatch,
                    "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((config.value.detect_title_mismatch) = $event)),
                    label: "检测整理前后中文名差异/识别错配",
                    color: "primary",
                    density: "compact",
                    "hide-details": ""
                  }, null, 8, ["modelValue"])
              ...
              _createVNode(_component_v_col, {
                ...
                default: _withCtx(() => [
                  _createVNode(_component_v_text_field, {
                    modelValue: config.value.title_mismatch_threshold,
                    "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => ((config.value.title_mismatch_threshold) = $event)),
                    type: "number",
                    step: "0.1",
                    label: "中文名相似度容差阈值 (0~1，默认0.3)",
                    density: "compact",
                    "hide-details": ""
                  }, null, 8, ["modelValue"])
                ]),
              ...
              _createVNode(_component_v_col, {
                ...
                default: _withCtx(() => [
                  _createVNode(_component_v_switch, {
                    ...
                    "onUpdate:modelValue": _cache[7] || (_cache[7] = $event => ((config.value.detect_merged_files) = $event)),
              ...
              _createVNode(_component_v_col, {
                ...
                default: _withCtx(() => [
                  _createVNode(_component_v_text_field, {
                    ...
                    "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((config.value.min_merged_files) = $event)),
                    type: "number",
                    label: "归并文件最小数量阈值",
                    density: "compact",
                    "hide-details": ""
              ...
              _createVNode(_component_v_col, {
                ...
                default: _withCtx(() => [
                  _createVNode(_component_v_switch, {
                    ...
                    "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => ((config.value.detect_english_title) = $event)),
                    label: "检测英文未中文化标题",
                    color: "primary",
                    density: "compact",
                    "hide-details": ""
              ...
              _createVNode(_component_v_col, {
                ...
                default: _withCtx(() => [
                  _createVNode(_component_v_switch, {
                    ...
                    "onUpdate:modelValue": _cache[10] || (_cache[10] = $event => ((config.value.detect_unidentified) = $event)),
                    label: "检测未识别 / TMDB 缺失",
                    color: "primary",
                    density: "compact",
                    "hide-details": ""
              ...
              _createVNode(_component_v_col, {
                ...
                default: _withCtx(() => [
                  _createVNode(_component_v_switch, {
                    ...
                    "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => ((config.value.detect_failed_status) = $event)),
                    label: "检测整理状态失败记录",
                    color: "primary",
                    density: "compact",
                    "hide-details": ""
              ...
              _createVNode(_component_v_col, {
                ...
                default: _withCtx(() => [
                  _createVNode(_component_v_switch, {
                    ...
                    "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => ((config.value.detect_duplicate_episode) = $event)),
                    label: "检测重复季集冲突",
                    color: "primary",
                    density: "compact",
                    "hide-details": ""
              ...
              _createVNode(_component_v_col, {
                ...
                default: _withCtx(() => [
                  _createVNode(_component_v_switch, {
                    ...
                    "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => ((config.value.detect_missing_dest) = $event)),
              ...
              _createVNode(_component_v_col, {
                ...
                default: _withCtx(() => [
                  _createVNode(_component_v_switch, {
                    ...
                    "onUpdate:modelValue": _cache[14] || (_cache[14] = $event => ((config.value.detect_invalid_episode) = $event)),
              ...
              _createVNode(_component_v_col, {
                ...
                default: _withCtx(() => [
                  _createVNode(_component_v_text_field, {
                    ...
                    "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((config.value.invalid_episode_threshold) = $event)),
                    type: "number",
                    label: "离群集数判断阈值",
                    density: "compact",
                    "hide-details": ""
              ...
              _createVNode(_component_v_col, { cols: "12" }, {
                default: _withCtx(() => [
                  _createVNode(_component_v_textarea, {
                    ...
                    "onUpdate:modelValue": _cache[16] || (_cache[16] = $event => ((config.value.ignore_paths) = $event)),
      ...
      _createVNode(_component_v_card_actions, { class: "px-4 pb-4 pt-0" }, {
        default: _withCtx(() => [
          ...
          _createVNode(_component_v_btn, {
            variant: "text",
            onClick: _cache[17] || (_cache[17] = $event => (_ctx.$emit('close')))
          }, {
